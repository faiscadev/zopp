...
- [principal Command](/zopp/reference/cli/principal/) - Principal management reference
- [permission Command](/zopp/reference/cli/permission/) - Permission management reference
