...
<CardGrid>
  <Card title="Architecture" icon="setting">
    Understand how zopp's zero-knowledge encryption works.

    [View architecture →](/zopp/security/architecture/)
  </Card>
  <Card title="Cryptography" icon="approve-check">
    Deep dive into the cryptographic primitives used by zopp.

    [View cryptography →](/zopp/security/cryptography/)
  </Card>
</CardGrid>
