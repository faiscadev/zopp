...
impl ZoppServer {
    ...
    pub(crate) fn max_role(&self, a: Option<zopp_storage::Role>, b: zopp_storage::Role) -> zopp_storage::Role {
        match a {
            None => b,
            Some(current) => {
    ...
    pub(crate) fn min_role(&self, a: zopp_storage::Role, b: zopp_storage::Role) -> zopp_storage::Role {
        if a.includes(&b) {
            b
        } else {
            a
